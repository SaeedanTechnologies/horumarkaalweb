...
import { NumberverifyOtp } from "../../../../../store/actions/appActions";
  import { Link } from "react-router-dom";
  
  const NumberVerifcationOtp = () => {
    ...
    const handleSubmit = () => {
      ...
      dispatch(NumberverifyOtp({ otp: otpValue }))
        .then((res) => {
  ...
  export default NumberVerifcationOtp;
