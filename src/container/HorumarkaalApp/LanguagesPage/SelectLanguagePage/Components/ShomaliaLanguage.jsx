...
import SearchOutlinedIcon from "@mui/icons-material/SearchOutlined";
import VolumeUpIcon from "@mui/icons-material/VolumeUp";
import { getTranslate, getConvertTextsoomaali } from "../../../../../store/actions/appActions"; // Adjust path as needed
import Loader from "../../../../../component/loader";
...
const ShomaliaLanguage = ({ language }) => {
  ...
  const searchTranslations = async () => {
    setLoading(true);
    try {
      const response = await dispatch(getTranslate(checkedSuggestions, "soomaali"));
      if (response.success) {
  ...
  const Row = ({ index, style }) => (
    <ListItem style={style} key={index}>
      <FormControlLabel
        control={
          <Checkbox
            checked={checkedSuggestions.includes(filteredSuggestions[index].soomaali)}
